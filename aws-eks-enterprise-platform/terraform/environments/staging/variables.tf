...
variable "public_subnet_cidrs" { type = list(string); default = ["10.10.0.0/24", "10.10.1.0/24", "10.10.2.0/24"] }
variable "private_subnet_cidrs" { type = list(string); default = ["10.10.10.0/21", "10.10.18.0/21", "10.10.26.0/21"] }
variable "isolated_subnet_cidrs" { type = list(string); default = ["10.10.40.0/28", "10.10.40.16/28", "10.10.40.32/28"] }
...
variable "notification_email" { type = string; default = null }
